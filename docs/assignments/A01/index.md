...
## Objective
Analytical Element: Analyze two portfolios against functional requirements and document your findings on your A1 portfolio page. Analyze a product based on the given criteria. Decision Element: Engage with the template critically and make three documented decisions. Communication Element: Populate the "about me" section of the portfolio.
## Analyze
Portfolio Analysis:

Github based Portfolio [https://nhoong.github.io/index.html](https://nhoong.github.io/)
...
d. Professional Tone: When measured against the standard of technical writing expected for an engineering resume for an employer, Nathan's portfolio definitely meets the standard in its project write-ups. One interesting part about his language is in the About section/page: he uses more general, non-technical language, then balances it out with his engineering vocabulary and background, which distinguishes between the two, creating a more welcoming and approachable format for anyone, not just engineers

Portfolio 2: Jack Stevens's Mechanical Engineering Portfolio https://johnduncanstevens.wixsite.com/portfolio

a.Navigability: Jack's portfolio is neatly organized in distinct tabbed pages between his engineering projects, home page, education, experience, technical skills, etc. Within his Engineering projects page, he has an index of all his individual engineering project cards, with "Click to see details" links attached to each. A reader searching for any of his named projects can go directly to this tab and locate the corresponding card without scrolling too far, making it achievable in under 60 seconds.

b.Reproducibility: Jack's project pages go very in-depth in documentation. Most of his projects include his full design timeline from start to finish, showing the initial planning phase through fabrication. In the example of his Formula Electric Pedal, he includes an index for all of his engineering projects, which describes tools used for each project, for example, Onshape, MATLAB, or ANSYS, and shows his SolidWorks drawings and renderings, from the Weld mounts and FEA for some of his FSAE chassis work. One lapse in his reproducibility is that he only lists the software used and doesn't document the procedure for how he used it, nor does he explicitly state a sequence of steps for someone to easily replicate the project.

c.Evidence of reasoning: While Jack does show some comparative reasoning, like for his bicep curl analysis where he reports some nuances and concludes in his conclusion, like how longer-limbed individuals need slightly more force in raw terms. However, most projects in his portfolio, like his Formula SAE chassis and capstone aeroponics project, report the outcome achieved without describing many of the design alternatives he considered or how many boundary conditions he used while running his FEA simulation. So, while reasoning is not absent, it is rather inconsistent across his portfolio.

d. Professional Tone: measured against the standard of technical writing expected in a mechanical engineering resume some field specific terminologies are used without definition and some of his Engineering projects page use very informal descriptions any in a fixed narrative with phrasing that's not typical of a document you would hand to an employer for engineering for example on the bicep curl page he used that at least what I tell my friends at the gym which is phrasing that wouldn't be appropriate For an employer.
