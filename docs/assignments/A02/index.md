...
#### Truss Failure Modes
From Any Engineering classes we have taken, we know that members can be in either tension or compression. From a little research [Here](https://baling-steel.com/astm-a500-grade-b-properties/), we can find that A500 steel is ductile. The material's 23% elongation indicates substantial plastic deformation, or necking, before it separates. So, from this, we are most likely to either see buckling or yielding within the system, not fracturing. For truss members in tension, yielding is most likely to happen, and for members in compression, buckling is most likely to happen. One design change I would consider is switching from a rectangular or circular beam to an I-beam. The advantage is that they are much more resistant to buckling than a rectangular beam of the same material.
#### Pin Failure Modes
Regarding the pin's expected failure mode, the most likely scenario is that it will shear under the applied loads. It is also possible that, with enough force and rigidity, the pin could pull out of the truss structure. However, given the size of the pins we are currently using in our system, the most likely failure mode would be sliding along the crystalline structure. I learned this information in my manufacturing systems lecture with Jose Outeiro. One main design change that could possibly prevent this failure is increasing the diameter of the pins, but that is only possible to a certain point because our truss structure is only so wide right now. If the pins get wide enough, we would have to redesign the truss structure to accommodate the larger pins, and if we are going to redesign the truss structure, we might as well design it to put less force on the pins. So, most likely, the best design change would be to design it so there is less force on the pins, which would allow for a thicker pin.
## Communicate
### Lessons
The lessons I learned from this assignment include many things like going about brainstorming out different designs going through the validation and deciding which one to push through with and in addition with that learning how to calculate all the internal forces, the minimum areas, The shear forces in the pin Are all very helpful lessons I learned throughout this assignment there's multiple things from this assignment that I will be able to take and learn to apply to my future classes or am taking currently. It was also a good refresher for Solidworks as I haven't used in over a year It was also a good assignment for teaching me how to think out of the box and think of different ways to make the equations work for the problems and crossing it with solid works to validate your answers was very helpful and gives you a lot of confidence as an engineer to see your work done right. I spent around 13 hours on this assignment, and I definitely could have managed my time a little better to not be in a rush to get it done, but overall, I feel very confident in my work for this assignment, and with a little improvement in time management, I can be capable of improving on each assignment over the course of the semester.
## Appendix
[Truss SolidWorks File](https://drive.google.com/file/d/1a592PClygc8nZHAsXrRwSjkLCfkiMeSy/view?usp=sharing)  
[Pin SolidWorks File](https://drive.google.com/file/d/1Uo24btfsYYNNlVjnHpcSW5sj1VQPHJAp/view?usp=sharing)
